...
def majasdarbs2():
    ...
    if a == b:
        rezultats = "Abi skaitļi ir vienādi"
    elif a > b:
        rezultats = "Pimais skaitlis ir lielāks"
    elif a < b:
        rezultats = "Otrais skaitlis ir lielāks"
    return render_template('majasdarbs.html', rezultats=rezultats)
